    ...
    <>
      <section className="bg-primary text-primary-foreground pt-16 pb-12 md:pt-24 md:pb-20">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <h1 className="font-heading text-2xl md:text-4xl lg:text-5xl lg:text-6xl font-bold mb-6">About Cade Legal</h1>
      ...
      <section className="py-16 md:py-24 bg-background">
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:flex-row items-start gap-8 md:gap-12 lg:gap-12 md:gap-20">
            <div className="w-full lg:w-1/3 relative lg:sticky lg:top-32">
              <div className="aspect-[4/5] relative rounded-2xl overflow-hidden bg-muted border border-border">
                ...
                <div className="absolute inset-0 flex items-center justify-center bg-secondary/50 text-secondary-foreground p-8 text-center">
                  <span className="font-heading text-lg md:text-xl">[ATTORNEY PHOTO — CLIENT TO PROVIDE]</span>
                </div>
              </div>
            </div>
            
            <div className="w-full lg:w-2/3">
              <h2 className="font-heading text-2xl md:text-4xl lg:text-5xl font-bold text-foreground mb-2">
                {attorneyData.name}
              </h2>
              <p className="text-primary font-medium text-lg md:text-xl mb-8 pb-8 border-b border-border">
                {attorneyData.title}
              </p>
